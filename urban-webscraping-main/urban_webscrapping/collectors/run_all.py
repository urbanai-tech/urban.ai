...
REST_COLLECTORS: tuple[CollectorSpec, ...] = (
    ...
    CollectorSpec("sp-cultura", "urban_webscrapping.collectors.sp_cultura", "SpCulturaCollector"),
    CollectorSpec("usp-eventos", "urban_webscrapping.collectors.usp_eventos", "UspEventosCollector"),
    CollectorSpec(
        "marcha-para-jesus",
    ...
    CollectorSpec("allianz-parque", "urban_webscrapping.collectors.allianz_parque", "AllianzParqueCollector"),
    CollectorSpec("anhembi", "urban_webscrapping.collectors.anhembi", "AnhembiCollector"),
    CollectorSpec("sao-paulo-expo", "urban_webscrapping.collectors.sao_paulo_expo", "SaoPauloExpoCollector"),
    CollectorSpec(
        "expo-center-norte",
    ...
    CollectorSpec("vibra-sao-paulo", "urban_webscrapping.collectors.vibra_sao_paulo", "VibraSaoPauloCollector"),
    CollectorSpec(
        "tokio-marine-hall",
        "urban_webscrapping.collectors.tokio_marine_hall",
        "TokioMarineHallCollector",
    ),
    CollectorSpec("espaco-unimed", "urban_webscrapping.collectors.espaco_unimed", "EspacoUnimedCollector"),
    CollectorSpec("wtc-sao-paulo", "urban_webscrapping.collectors.wtc_sao_paulo", "WtcSaoPauloCollector"),
