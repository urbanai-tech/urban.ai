...
| `workspace atual` - `test: cover billing email templates` | F, J | Jest cobre templates de assinatura ativa, falha de pagamento, quota warning/exceeded com valores, datas e links sem `undefined`. |
...
| F9 | P1 | E-mails transacionais: assinatura ativa, falha, cancelada, quota warning/exceeded | Mailersend | Templates de assinatura/falha/quota testados; falta disparo real nos eventos certos. |
