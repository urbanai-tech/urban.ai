...
| M3 - Beta pago / go-live controlado | **62%** | Operacao, release gate, historico de jobs, audit log admin, suporte/LGPD, contatos, ROI, E2E prod 100% read-only, checkout oficial corrigido, smoke Stripe documentado e migration de `price_updates` reduziram risco; ainda falta prova para cobrar. | Executar Stripe/KYC/smoke, cases, billing real, suporte e legal. |
