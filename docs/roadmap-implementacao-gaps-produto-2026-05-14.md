...
| M3 - Beta pago / go-live controlado | **42%** | Operacao, release gate, historico de jobs, smoke Stripe e gate Stays beta privado melhoraram, mas ainda nao ha prova suficiente para cobrar com tranquilidade. | Executar Stripe/KYC/smoke, cases, audit log amplo, suporte e legal. |
