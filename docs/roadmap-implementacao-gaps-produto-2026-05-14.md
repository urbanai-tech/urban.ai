...
| F10 | P2 | Fluxo de upsell de quantity via Stripe Portal ou update direto | F5 | Backend cria sessao Stripe Billing Portal; falta conectar CTA no front e validar portal/webhook em Stripe test mode. |
