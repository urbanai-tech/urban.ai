...
| Admin e operacao | **69%** | Dashboard executivo com eventos, pricing, dataset, billing e Stays; `/admin/jobs` roda geocoder/reset/snapshot com historico persistente e permite abrir resultado antigo; waitlist permite reenvio/copia de convite. | Audit log amplo, drill-down por propriedade, alertas externos. |
