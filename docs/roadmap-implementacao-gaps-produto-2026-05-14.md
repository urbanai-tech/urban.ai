...
| M3 - Beta pago / go-live controlado | **44%** | Operacao, release gate, historico de jobs, smoke Stripe, gate Stays, playbook de beta/cases e staging release drill melhoraram, mas ainda nao ha prova suficiente para cobrar com tranquilidade. | Executar Stripe/KYC/smoke, cases, audit log amplo, suporte e legal. |
