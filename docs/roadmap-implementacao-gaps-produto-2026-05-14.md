...
|---|---:|---|---|
| M1 - Pre-lancamento seguro | **81%** | Waitlist, e-mail de entrada, convite definitivo e painel admin estao bem mais operaveis; falta prova real ponta-a-ponta. | GA4/Pixel reais, teste com 5 leads, smoke de e-mail/convite em staging/prod e conferir copy em todos os canais. |
...
|---|---:|---|---|
| Narrativa e prelaunch | **82%** | Copy mais segura, `LAUNCH_MODE`, envs publicas no Docker, waitlist/analytics instrumentados, e-mail de confirmacao, aceite de convite real e admin com reenvio/copia de link. | Validar fluxo real com 5 leads, MailerSend e GA4/Pixel. |
...
| F1 | 2-3 dias | Pre-lancamento seguro | 81% | E-mail de entrada, convite definitivo e admin waitlist avancaram; falta validar prod/staging | Waitlist testada, analytics pronto, copy ajustada. |
