...
| M2 - Beta fechado assistido | **54%** | O core ganhou mais operacao: preco aplicado alimenta dataset, admin roda snapshot, coletores alertam com menos falso positivo e o smoke de recomendacao nova ficou formalizado. | Eventos futuros suficientes, recomendacoes com data atual, snapshots por 7 dias e amostra real de preco aplicado. |
...
| Infra/release | **59%** | Health/config melhores, Docker frontend/webscraping corrigido, runner evita sucesso falso, runbook de release gate, runbook de fallback de eventos, smoke de recomendacao nova, protocolo para devs/agentes e migration de historico admin. | Staging, branch protection, smoke automatizado, restore drill. |
