...
Lista priorizada do que **só você consegue fazer** — fora do meu alcance pelo IDE. Datas estimadas em "semanas" referem-se ao cronograma do `docs/archive/roadmaps/roadmap-pos-sprint.md`.
...
- Detalhes em `docs/archive/roadmaps/roadmap-pos-sprint.md` § F5.4
