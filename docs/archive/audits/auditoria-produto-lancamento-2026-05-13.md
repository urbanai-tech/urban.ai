...
> SUPERSEDED: snapshot historico. Consulte `../../auditoria-360-arquitetura-produto-ui-ux-2026-07-15.md` para o estado atual.
...
- `docs/archive/roadmaps/roadmap.md`
- `docs/archive/roadmaps/roadmap-pos-sprint.md`
- `docs/archive/plans/backlog-produto-pos-assuncao.md`
- `docs/runbooks/go-live-manual-checklist.md`
- `docs/product/business/base-socios.md`
- `docs/archive/data/estado-da-IA-e-evolucao.md`
- `docs/archive/data/fase-eventos-cobertura-total.md`
- `docs/archive/plans/next-actions.md`
