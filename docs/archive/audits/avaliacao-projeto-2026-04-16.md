...
**Bom:** a pasta `docs/` está ativa e densa. Relatórios de status recorrentes, roadmap detalhado, brand book, presentations. O snapshot `archive/reports/relatorio-status-semanas3-4.md` (13/04) é exemplar — 20KB, bem estruturado, com commits referenciados.

**Roadmaps:** `roadmap.md` (original), `roadmap-pos-sprint.md` (snapshot Markdown) e `archive/docx/reports-plans/roadmap-assumir-operacao.docx` (histórico).
