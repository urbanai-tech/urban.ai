...
Substitui/complementa: `docs/archive/audits/auditoria-confiabilidade-dados-graficos-relatorios-2026-05-21.md` e `docs/archive/audits/auditoria-mocks-hardcoded-admin-usuarios-2026-05-21.md`.
...
|---|---|---|
| `archive/audits/auditoria-confiabilidade-dados-graficos-relatorios-2026-05-21.md` | Correto como delta curto, incompleto para estado atual | Arquivado; consultar auditoria 360 atual |
| `archive/audits/auditoria-mocks-hardcoded-admin-usuarios-2026-05-21.md` | Correto para runtime naquele snapshot | Arquivado; consultar auditoria 360 atual |
| `auditoria-pwa-push-notifications-2026-05-21.md` | Veredito inicial ficou historico | Arquivado; superado pela implementação Web Push |
