...
>
> **Fonte operacional atual:** [`docs/archive/roadmaps/roadmap-implementacao-gaps-produto-2026-05-14.md`](./roadmap-implementacao-gaps-produto-2026-05-14.md), com fases, gates e gaps de produto atualizados em 2026-05-15.
>
...
> 📘 **Para sócios / pitch:** [`docs/product/business/base-socios.md`](../../product/business/base-socios.md) — base centralizada de status, em linguagem direta.
> 📕 **Para tecnologia / IA:** [`docs/archive/data/estado-da-IA-e-evolucao.md`](../data/estado-da-IA-e-evolucao.md) — referência consolidada.
...
> 2. **Fase F6.2 Plus** — cobertura total de eventos em SP (3 camadas: APIs oficiais → Firecrawl → curadoria) AUTORIZADA pelo Gustavo. Custo ~US$ 40/mês. Entrega 6 semanas. Doc dedicado: `docs/archive/data/fase-eventos-cobertura-total.md`.
> 3. **`docs/product/business/base-socios.md`** — documento executivo para conversar com Fabrício/Rogério, organizado em 7 partes (status, IA, eventos, cronograma, decisões pendentes, custos, como acompanhar).
...
> - **Doc consolidado para sócios?** [`docs/product/business/base-socios.md`](../../product/business/base-socios.md) entregue.
...
> 4. **`docs/archive/data/estado-da-IA-e-evolucao.md`** — documento principal consolidado para apresentações.
>
...
> 5. **`docs/archive/plans/next-actions.md`** consolidando 18 ações operacionais que dependem de você.
>
...
- ✅ `docs/ops/slo.md` (uptime 99.5%, RTO 2h, RPO 24h, error budget)
