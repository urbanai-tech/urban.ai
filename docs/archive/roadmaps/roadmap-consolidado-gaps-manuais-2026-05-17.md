...
| Fonte | Uso atual |
| --- | --- |
| `docs/archive/roadmaps/roadmap-4-tracks-2026-05-17.md` | Fonte operacional mais atual por dev/track. |
| `docs/archive/roadmaps/roadmap-implementacao-gaps-produto-2026-05-14.md` | Fonte macro de produto; algumas porcentagens antigas foram recalibradas aqui. |
| `docs/runbooks/go-live-manual-checklist.md` | Checklist humano/externo; ainda relevante para Stripe, MailerSend, Google, Stays, GitHub, backup, DNS e LGPD. |
...
| `docs/archive/audits/auditoria-ui-ux-*-2026-05-16.md` | Base histórica de UX/design e validações visuais. Para o estado atual, usar a auditoria 360 canônica. |
