...
| --- | --- | --- |
| `docs/archive/roadmaps/roadmap-4-tracks-2026-05-17.md` | Placar por dev/track e divisao operacional | Fonte principal por squad |
| `docs/archive/roadmaps/roadmap-execucao-restante-2026-05-17.md` | Passo a passo do que ainda da para executar | Fonte principal de acao |
| `docs/archive/roadmaps/roadmap-consolidado-gaps-manuais-2026-05-17.md` | Gaps manuais, externos, PWA/mobile e leitura executiva | Fonte principal de bloqueios |
