...
Lista compacta. Versão completa em `docs/archive/plans/next-actions.md`.
...
| Doc | Cobre |
|---|---|
| `docs/archive/roadmaps/roadmap-pos-sprint.md` v2.7 | Roadmap completo com fases e marcos |
| `docs/archive/audits/avaliacao-projeto-2026-04-16.md` | Auditoria técnica que motivou F5C |
| `docs/archive/plans/next-actions.md` | 18 ações operacionais detalhadas |
...
| `docs/ops/slo.md` | SLO/SLA + error budget |
