...
> [avaliação completa do projeto](avaliacao-completa-projeto-2026-07-02.md).
>
...
Nota: nenhum `.env` real foi commitado; nenhum secret ativo no working tree. Mas `docs/relatorio-testes-2026-03-18.md` menciona uso de uma chave `sk_live_` da Stripe — **confirmar rotação**.
