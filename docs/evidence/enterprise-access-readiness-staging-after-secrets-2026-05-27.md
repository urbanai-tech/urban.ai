...
Generated at: 2026-05-27T15:29:56.473Z
Env file: `C:/Users/gusta/OneDrive/Documentos/GitHub/Urban AI/.env.staging`
...
| --- | --- | --- | --- |
| Enterprise live gate read-only | READY | none | ENTERPRISE_GATE_ADMIN_JWT, ENTERPRISE_GATE_HOST_JWT |
| Events ingest controlled smoke | READY | none | none |
| Restore drill verifier | BLOCKED | RESTORE_DATABASE_URL | none |
| Stays sandbox/assisted account smoke | BLOCKED | STAYS_API_BASE_URL | STAYS_AUTO_APPLY_ALLOWED_USER_IDS, STAYS_AUTO_APPLY_ALLOWED_LISTING_IDS |
...
| --- | --- | --- | --- |
| ENTERPRISE_GATE_BACKEND_URL | required | yes | ENTERPRISE_GATE_BACKEND_URL |
| ENTERPRISE_GATE_FRONTEND_URL | required | yes | ENTERPRISE_GATE_FRONTEND_URL |
| ENTERPRISE_GATE_HEALTH_TOKEN | required | yes | ENTERPRISE_GATE_HEALTH_TOKEN |
...
| --- | --- | --- | --- |
| ENTERPRISE_GATE_BACKEND_URL | required | yes | ENTERPRISE_GATE_BACKEND_URL |
| ENTERPRISE_GATE_EVENTS_INGEST_KEY | required | yes | ENTERPRISE_GATE_EVENTS_INGEST_KEY |
...
| STAYS_TOKEN_ENCRYPTION_KEY | required | yes | STAYS_TOKEN_ENCRYPTION_KEY |
| STAYS_AUTO_APPLY_ENABLED | recommended | yes | STAYS_AUTO_APPLY_ENABLED |
| STAYS_AUTO_APPLY_DRY_RUN | recommended | yes | STAYS_AUTO_APPLY_DRY_RUN |
