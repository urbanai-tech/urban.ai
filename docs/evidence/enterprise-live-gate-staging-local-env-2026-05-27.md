...
Generated at: 2026-05-27T15:22:30.569Z
Run id: `enterprise-gate-20260527T152230568Z`
Environment: `staging`
Dry run: no
...
| --- | --- | --- | --- |
| backend.live | PASS | 866ms | GET /health/live returns status ok |
| backend.health | SKIP | 0ms | Detailed /health needs ENTERPRISE_GATE_HEALTH_TOKEN or HEALTH_READINESS_TOKEN. |
| frontend.root | PASS | 748ms | Frontend root responds |
