...
- `docs/`: 13 pastas `e2e-reports/` + 4 `controlled-flows/` com timestamps (artefatos de teste), 5 versões de "Relatorio Status" (~16MB), 2 estruturas de documentação (`urban-ai-documentacao/` + `v2-2026-05-24/`).
