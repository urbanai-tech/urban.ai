# Relatorio E2E Produto - 2026-05-15T13:01:21.813Z
...
Entrega funcional estimada: **87%**

### Problemas encontrados

- **P2** `/admin`: Visible error pattern: /\b500\b/i
- **P2** `/admin/dashboard`: Visible error pattern: /\b500\b/i
- **P2** `/admin/dashboard`: Console: error: Failed to load resource: the server responded with a status of 500 ()
- **P2** `/admin/stays`: Visible error pattern: /\b500\b/i
- **P2** `/admin/stays`: Console: error: Failed to load resource: the server responded with a status of 500 ()
- **P0** `/admin/dashboard-summary`: HTTP 500
- **P0** `/admin/stays/health`: HTTP 500
...
|---|---|---:|---|---|
| `/admin` | Admin home | 200 | FALHA | Visible error pattern: /\b500\b/i |
| `/admin/dashboard` | Executive dashboard | 200 | FALHA | Visible error pattern: /\b500\b/i<br>Console: error: Failed to load resource: the server responded with a status of 500 () |
...
| `/admin/stays` | Stays admin health | 200 | FALHA | Visible error pattern: /\b500\b/i<br>Console: error: Failed to load resource: the server responded with a status of 500 () |
...
|---|---:|---|---|
| `/admin/dashboard-summary` | 500 | FALHA | object(statusCode,message) |
...
| `/admin/contact-submissions` | 200 | OK | object(page,limit,total,items) |
...
| `/admin/jobs/runs` | 200 | OK | array(0) |
...
| `/admin/stays/health` | 500 | FALHA | object(statusCode,message) |
