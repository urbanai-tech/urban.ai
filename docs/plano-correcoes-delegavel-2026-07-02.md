...
> ([avaliação](avaliacao-completa-projeto-2026-07-02.md) ·
> [auditorias consolidadas](auditorias-consolidadas-2026-07-02.md)).
>
...
2. **Rotação de credenciais (dev + owner):**
   ...
   - Confirmar rotação da chave `sk_live_` da Stripe citada em `docs/relatorio-testes-2026-03-18.md` (gerar nova no dashboard Stripe, atualizar `STRIPE_SECRET_KEY` no Railway, revogar a antiga).
...
**Contexto.** Só 2 de 12 pontos de falha silenciosa têm alerta. Detalhes e snippets em `docs/auditorias-consolidadas-2026-07-02.md` (Auditoria 6).
...
4. **"modelo aprende a cada análise" / "20-40%":** suavizar para linguagem de estimativa/aspiração com disclaimer (sugestões de reescrita honesta em `docs/auditorias-consolidadas-2026-07-02.md`, Auditoria 5).
