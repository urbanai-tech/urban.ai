...
const propertyImpacts: Record<string, EventPropertyImpact[]> = {
  ...
  "evt-ibirapuera-festival": [
    ...
    },
    {
      ...
      mainDrivers: ["Acesso viável por transporte", "Público de lazer", "Concorrência ainda disponível"],
      affectedNights: ["2026-07-04"],
  ...
  "evt-esports-final": [
    {
      ...
      mainDrivers: ["Público jovem", "Evento concentrado em uma noite", "Busca ainda em formação"],
  ...
  "evt-food-week-pending-geo": [
    {
      ...
      confidence: "medium",
      recommendedAction: "review",
      mainDrivers: ["Endereço pendente", "Público gastronômico", "Potencial alto antes do geocoder"],
...
const catalogItems: EventCatalogItem[] = [
  {
    ...
    description: "Conferência de tecnologia com público corporativo e alta procura por hospedagem perto de eixos de mobilidade.",
  ...
  },
  {
    ...
    name: "Festival de Música no Ibirapuera",
  ...
  },
  {
    ...
    name: "Congresso Médico Paulista",
...
const intelligenceById: Record<string, EventIntelligenceDetail["intelligence"]> = {
  ...
  "evt-esports-final": {
    ...
    drivers: [
      { key: "niche", label: "Público específico", weight: 0.24, explanation: "Pode ter alta intenção, mas menor volume que congresso ou festival." },
