...
const scenariosByProperty: Record<string, PriceAbsorptionScenario[]> = {
  "prop-vila-mariana": [
    ...
    },
    {
      ...
      risk: "medium",
      recommended: true,
      reading: "Melhor equilibrio entre diaria maior e chance de reservar.",
    },
    {
      id: "aggressive",
      label: "Agressivo",
    ...
    },
    {
      ...
      risk: "high",
      reading: "So faz sentido com compressao extrema de oferta.",
    },
  ],
  "prop-paulista": [
    {
      ...
      risk: "low",
      reading: "Bom para garantir ocupacao antes do pico de busca.",
    },
    {
      id: "recommended",
      label: "Recomendado",
      ...
      risk: "medium",
      recommended: true,
      reading: "Faixa mais provavel de absorcao para este imovel.",
    },
    {
      id: "aggressive",
      label: "Agressivo",
  ...
  "prop-pinheiros": [
    {
      ...
      risk: "low",
      reading: "Boa opcao se a prioridade for preencher agenda.",
    },
    {
      id: "recommended",
      label: "Recomendado",
      ...
      risk: "medium",
      recommended: true,
      reading: "Preco ainda competitivo para demanda aquecida.",
    },
    {
      id: "aggressive",
      label: "Agressivo",
      ...
      risk: "high",
      reading: "So vale testar se houver sinal de compressao no entorno.",
    },
    {
      id: "extreme",
      label: "Extremo",
      ...
      risk: "high",
      reading: "Alta chance de vacancia para este perfil.",
    },
  ],
};
  ...
  "evt-tech-summit-sp": [
    {
      ...
      mainDrivers: ["Muito perto do evento", "Alta antecedencia de busca", "Oferta limitada no bairro"],
    ...
    },
    {
      ...
      confidence: "medium",
      recommendedAction: "simulate",
      mainDrivers: ["Boa conexao por metro", "Perfil corporativo", "Diaria atual abaixo do pico"],
      affectedNights: ["2026-06-12", "2026-06-13"],
  ...
  "evt-ibirapuera-festival": [
    {
      ...
      mainDrivers: ["Evento de grande porte", "Publico noturno", "Regiao com alta procura"],
    ...
    },
    {
      ...
      mainDrivers: ["Acesso viavel por transporte", "Publico de lazer", "Concorrencia ainda disponivel"],
      affectedNights: ["2026-07-04"],
  ...
  "evt-medical-congress": [
    {
      ...
      confidence: "high",
      recommendedAction: "apply",
      mainDrivers: ["Hospede quer ficar perto", "Evento de multiplos dias", "Demanda corporativa"],
  ...
  "evt-esports-final": [
    {
      ...
      mainDrivers: ["Publico jovem", "Evento concentrado em uma noite", "Busca ainda em formacao"],
  ...
  "evt-food-week-pending-geo": [
    {
      ...
      confidence: "medium",
      recommendedAction: "review",
      mainDrivers: ["Endereco pendente", "Publico gastronomico", "Potencial alto antes do geocoder"],
...
const catalogItems: EventCatalogItem[] = [
  {
    ...
    name: "Sao Paulo Tech Summit",
    description: "Conferencia de tecnologia com publico corporativo e alta procura por hospedagem perto de eixos de mobilidade.",
    ...
    demandScore: 91,
    confidence: "high",
    badges: ["alto impacto", "perto de voce", "fonte oficial", "demanda aquecida"],
  },
  {
    id: "evt-ibirapuera-festival",
    name: "Festival de Musica no Ibirapuera",
    description: "Festival ao ar livre com fluxo noturno e chance de aquecer a regiao por uma noite.",
  ...
  },
  {
    ...
    description: "Congresso de tres dias com perfil profissional e demanda previsivel perto de hospitais e centro de convencoes.",
    startsAt: "2026-06-26T09:00:00.000Z",
    endsAt: "2026-06-28T18:00:00.000Z",
    city: "Sao Paulo",
    state: "SP",
    venueName: "Centro de Convencoes Frei Caneca",
    ...
    demandScore: 83,
    confidence: "high",
    badges: ["perto de voce", "evento monitorado", "fonte em validacao"],
  },
  {
    id: "evt-esports-final",
    name: "Final Estadual de E-sports",
    description: "Final competitiva com publico concentrado em uma noite e possivel pico de busca em Pinheiros.",
  ...
  },
  {
    ...
    description: "Evento com bom sinal de demanda, mas ainda sem coordenada confiavel do venue.",
...
const intelligenceById: Record<string, EventIntelligenceDetail["intelligence"]> = {
  "evt-tech-summit-sp": {
    ...
    confidence: "high",
    interpretation: "Este evento deve aquecer a regiao por 2 noites. Seus imoveis perto de metro ou vias rapidas tendem a capturar melhor a demanda corporativa.",
    drivers: [
      { key: "attendance", label: "Publico esperado", weight: 0.34, explanation: "Volume alto para a cidade e publico com maior disposicao a pagar por conveniencia." },
      { key: "lead_time", label: "Antecedencia", weight: 0.22, explanation: "Ha tempo suficiente para testar preco sem pressionar ocupacao." },
      { key: "supply", label: "Oferta no entorno", weight: 0.2, explanation: "A oferta proxima tende a comprimir perto da data." },
    ],
    riskFlags: ["Estimativa baseada em fonte externa", "Capacidade ainda nao confirmada pelo organizador"],
    generatedAt,
  ...
  "evt-ibirapuera-festival": {
    ...
    confidence: "high",
    interpretation: "O festival deve concentrar demanda por uma noite. A faixa segura aparece antes do agressivo porque a estadia media tende a ser curta.",
    drivers: [
      { key: "venue", label: "Venue forte", weight: 0.3, explanation: "Ibirapuera cria demanda regional e facil reconhecimento pelo hospede." },
      { key: "night_event", label: "Evento noturno", weight: 0.24, explanation: "Hospedes tendem a buscar hospedagem perto depois do evento." },
  ...
  "evt-medical-congress": {
    ...
    confidence: "high",
    interpretation: "Congresso de varios dias costuma gerar demanda menos explosiva, mas mais previsivel. Imoveis perto da Paulista podem cobrar premio de conveniencia.",
    drivers: [
      { key: "multi_day", label: "Multiplos dias", weight: 0.28, explanation: "Aumenta noites impactadas e chance de reserva." },
      { key: "business", label: "Perfil profissional", weight: 0.26, explanation: "Hospede valoriza localizacao e previsibilidade." },
      { key: "distance", label: "Proximidade", weight: 0.22, explanation: "Loft Paulista esta dentro do raio de maior impacto." },
    ],
  ...
  "evt-esports-final": {
    ...
    confidence: "medium",
    interpretation: "Evento relevante, mas concentrado em uma noite. O melhor caminho e simular antes de aplicar preco agressivo.",
    drivers: [
      { key: "niche", label: "Publico especifico", weight: 0.24, explanation: "Pode ter alta intencao, mas menor volume que congresso ou festival." },
      { key: "distance", label: "Proximidade", weight: 0.24, explanation: "Apartamento Pinheiros esta bem posicionado." },
      { key: "confidence", label: "Fonte em validacao", weight: 0.16, explanation: "Ainda ha incerteza sobre publico final." },
    ],
    riskFlags: ["Confianca media", "Evento de uma noite"],
    generatedAt,
    modelVersion: "mock-v0",
    metricVersion: "event-demand-v0",
    jobRunId: "mock-host-radar-2026-05-22",
  ...
  "evt-food-week-pending-geo": {
    ...
    confidence: "medium",
    interpretation: "A demanda parece relevante, mas a recomendacao fica em revisao ate o venue receber coordenada confiavel.",
    drivers: [
      ...
      { key: "lead_time", label: "Antecedencia", weight: 0.18, explanation: "Ainda ha janela para validar endereco antes de aplicar preco." },
    ],
...
function matchesCatalogFilters(item: EventCatalogItem, filters: HostEventCatalogFilters = {}) {
  ...
  if (filters.nearMyProperties && !(item.badges ?? []).includes("perto de voce")) return false;
