      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <section className="border-t border-slate-800 pt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <NavCard href="/admin/collectors-health" title="Saúde dos coletores" desc="Volume + qualidade por source (24h/7d)" />
            <NavCard href="/admin/jobs" title="Jobs operacionais" desc="Geocoder, reset de enriquecimento e atalhos de readiness" />
