...
const visualErrorPatterns = [
  ...
  /\b404\s+(not found|não encontrado)|página não encontrada/i,
  /\b500\s+(internal server error|erro interno)/i,
  /Acesso negado/i,
  /Forbidden/i,
  /Network Error/i,
  /Erro ao carregar/i,
...
async function loginViaUi(page) {
  ...
  await page.goto(new URL('/login', APP_URL).toString(), { waitUntil: 'domcontentloaded' });
